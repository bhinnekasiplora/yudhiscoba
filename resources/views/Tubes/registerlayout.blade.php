	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type NIK">
						<input id="first-name" class="input100" type="number" name="NIK" placeholder="NIK">
						<span class="focus-input100"></span>
					</div> <br>
					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Type name">
          ...
          <div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type telephone">
						<input id="first-name" class="input100" type="tel" name="telephone" placeholder="Number Phone">
						<span class="focus-input100"></span>
					</div> <br>
          ...
          <div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type Alamat">
						<textarea class="input100" id="first-name" placeholder="Alamat Lengkap"></textarea>
						<span class="focus-input100"></span>
					</div> <br>

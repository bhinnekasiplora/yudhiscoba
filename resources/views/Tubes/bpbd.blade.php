      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="/blog">HOME</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#login">VALIDASI LAPORAN</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead" style="background-image: url('img/gunung2.jpg')">
      <div class="container">
        <div class="intro-text">
          ...
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="">VALIDASI LAPORAN</a><br><br> 
